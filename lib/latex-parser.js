  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ForceHyphenation": parse_ForceHyphenation,
        "ForceSpace": parse_ForceSpace,
        "Command": parse_Command,
        "MathBlock": parse_MathBlock,
        "SingleLineMathCharacters": parse_SingleLineMathCharacters,
        "MultiLineMathCharacter": parse_MultiLineMathCharacter,
        "MultiLineMathCharacters": parse_MultiLineMathCharacters,
        "SingleLineMathCharacter": parse_SingleLineMathCharacter,
      ...
      function parse_SourceElement() {
        ...
        if (result0 === null) {
          pos0 = clone(pos);
          result0 = parse_MathBlock();
          if (result0 !== null) {
            result0 = (function(offset, line, column, math) { return {math : math} })(pos0.offset, pos0.line, pos0.column, result0);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 === null) {
                result0 = parse_ForceHyphenation();
                if (result0 === null) {
                  result0 = parse_ForceSpace();
                }
              }
            }
          }
      ...
      function parse_ForceHyphenation() {
        var result0;
      ...
      function parse_MathBlock() {
        ...
        if (result0 !== null) {
          result1 = parse_MultiLineMathCharacters();
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, mathChars) { return mathChars })(pos0.offset, pos0.line, pos0.column, result0[1]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result1 = parse_SingleLineMathCharacters();
            result1 = result1 !== null ? result1 : "";
            if (result1 !== null) {
              if (input.charCodeAt(pos.offset) === 36) {
                result2 = "$";
      ...
      function parse_SingleLineMathCharacters() {
        var result0, result1;
        var pos0;
        
        pos0 = clone(pos);
        result1 = parse_SingleLineMathCharacter();
        if (result1 !== null) {
          result0 = [];
          while (result1 !== null) {
            result0.push(result1);
      ...
      function parse_MultiLineMathCharacter() {
        var result0, result1;
        var pos0, pos1, pos2;
      ...
      function parse_MultiLineMathCharacters() {
        var result0, result1;
        var pos0;
        
        pos0 = clone(pos);
        result1 = parse_MultiLineMathCharacter();
        if (result1 !== null) {
          result0 = [];
          while (result1 !== null) {
            result0.push(result1);
      ...
      function parse_SingleLineMathCharacter() {
        var result0, result1;
        var pos0, pos1, pos2;
      ...
      function parse_CommandArgument() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            result2 = parse_SquareCharacters();
            result2 = result2 !== null ? result2 : "";
            if (result2 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, squareArg) { return "[" + squareArg + "]" })(pos0.offset, pos0.line, pos0.column, result0[2]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, line, column, curlyArg) { return "{" + curlyArg + "}" })(pos0.offset, pos0.line, pos0.column, result0[2]);
          }
          if (result0 === null) {
            pos = clone(pos0);
          }
